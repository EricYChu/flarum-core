...
class StartPhoneVerificationHandler
{
    /**
    ...
    /**
     * @param StartPhoneVerification $command
     */
    public function handle(StartPhoneVerification $command)
    {
        $actor = $command->actor;
        $data = $command->data;
        ...
        $this->phoneVerification->start($actor, $phone);
    }
}
